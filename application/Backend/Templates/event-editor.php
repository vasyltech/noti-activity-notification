<?php if (defined('REACTIVE_LOG_KEY')) { ?>
    <div>
        ...
        <div class="rl-alert-danger<?php echo (empty($error) ? ' hidden' : ''); ?>" id="doc-parsing-error">
            <?php echo $error; ?>
        </div>

        <textarea id="event-editor" class="event-editor" rows="10"><?php echo $raw; ?></textarea>

        <input type="hidden" name="event-type-content" id="event_type_content" value="<?php echo stripslashes($post->post_content); ?>" />
        ...
        <script><?php echo file_get_contents(REACTIVE_LOG_MEDIA . '/codemirror.js'); ?></script>
